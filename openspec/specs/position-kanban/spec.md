...
Dar al equipo de reclutamiento una vista de tablero kanban para seguir y gestionar el avance de los candidatos dentro del proceso de contratación de una posición concreta: una columna por cada fase del `interviewFlow` de la posición, una tarjeta por candidato en su fase actual, y la posibilidad de mover candidatos de fase arrastrando su tarjeta entre columnas, con persistencia en el backend.
