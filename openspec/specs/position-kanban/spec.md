...
Página de detalle de una posición (`/positions/:id`) que muestra en un tablero kanban los candidatos de esa posición, agrupados por fase del proceso de contratación. Permite cambiar a un candidato de fase arrastrando su tarjeta. Incluye la navegación desde y hacia el listado de posiciones y el comportamiento responsive.
